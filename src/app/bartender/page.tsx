...
import { Martini, MonitorUp } from "lucide-react";
  ...
  return (
    <AppShell>
      <div className="mb-5">
        ...
        <p className="mt-2 text-white/55">Select an assigned event and open the POS.</p>
      </div>
          ...
          <TapMotion key={event.id}>
            <div className="ticket-card glass-card shine block p-5">
              <div className="flex items-start justify-between gap-3">
                ...
                <MonitorUp className="text-cyan-200" size={20} />
              </div>
              <MotionPanel className="mt-5">
                <h2 className="text-2xl font-black text-white">{event.name}</h2>
                <p className="mt-2 text-sm text-white/55">Sell items, charge wallets, and update the station monitor.</p>
              </MotionPanel>
              <div className="mt-5">
